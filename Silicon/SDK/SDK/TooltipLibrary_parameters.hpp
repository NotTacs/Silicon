...
public:
	class APlayerController*                      Owning_Player;                                     // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHeroCoreStat                          Data;                                              // 0x0008(0x0320)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
	float                                         Value;                                             // 0x0328(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_32C[0x4];                                      // 0x032C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                __WorldContext;                                    // 0x0330(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUserWidget*                            Output;                                            // 0x0338(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTooltipMinusCoreStat_C*                CallFunc_Create_ReturnValue;                       // 0x0340(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(TooltipLibrary_C_Create_Core_Stat_Tooltip) == 0x000348, "Wrong size on TooltipLibrary_C_Create_Core_Stat_Tooltip");
...
static_assert(offsetof(TooltipLibrary_C_Create_Core_Stat_Tooltip, Value) == 0x000328, "Member 'TooltipLibrary_C_Create_Core_Stat_Tooltip::Value' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Core_Stat_Tooltip, __WorldContext) == 0x000330, "Member 'TooltipLibrary_C_Create_Core_Stat_Tooltip::__WorldContext' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Core_Stat_Tooltip, Output) == 0x000338, "Member 'TooltipLibrary_C_Create_Core_Stat_Tooltip::Output' has a wrong offset!");
static_assert(offsetof(TooltipLibrary_C_Create_Core_Stat_Tooltip, CallFunc_Create_ReturnValue) == 0x000340, "Member 'TooltipLibrary_C_Create_Core_Stat_Tooltip::CallFunc_Create_ReturnValue' has a wrong offset!");
