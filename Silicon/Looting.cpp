...
std::vector<FFortItemEntry> Looting::PickLootDrops(FName LootTierGroup) {
	...
	UDataTable* LootTierData_Client = Utils::StaticLoadObject<UDataTable>("/Game/Items/DataTables/AthenaLootTierData_Client.AthenaLootTierData_Client");
	
	UDataTable* LootPackages_Client = Utils::StaticLoadObject<UDataTable>("/Game/Items/DataTables/AthenaLootPackages_Client.AthenaLootPackages_Client");
	...
	for (float I = 0; I < NumLootPackageDrops; I++) {
		...
		UFortItemDefinition* ItemDef = Utils::StaticLoadObject<UFortItemDefinition>(UKismetStringLibrary::Conv_NameToString(LootPackageCall->ItemDefinition.ObjectID.AssetPathName).
			ToString());
